        ...
        <div class="inn">
            ...
            <div class="row register-form">
                <div class="col-md-7 welcome-message" style="padding-top: 48px;">
                    <h1>Hydra DEX</h1>
                    <p>Our first step to real decentralized exchange platform</p>
                    <p>Start using Hydra exchange platform to buy or sell coins that you can't find anywhere!</p>
                    <br />
                    <div><a href="/app/" class="btn btn-success" style="background-color: #e40045; border-color: #fff; font-size: 30px;">Start trading</a></div>
